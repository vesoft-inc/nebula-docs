...
我们推荐使用在使用 [docker compose](https://github.com/vesoft-inc/nebula-docker-compose) 来安装 **Nebula Graph**， 具体步骤可以参考下面的视频：

<iframe src="//player.bilibili.com/player.html?aid=78745928&bvid=BV1BJ411y7Kt&cid=134739315&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
...
<details>
<summary>示例一: 查询 VID 100 关注的点。</summary>
...
<details>
<summary>示例二: 查询 VID 100 关注的点且该点年龄大于 35 岁。</summary>
...
<details>
<summary>示例三: 查询球员 100 关注的球员所效力的球队。</summary>
...
如果您要插入数百万条记录，可以使用以下几种方式：
1. 使用 [go-importer 工具](https://github.com/vesoft-inc/nebula-importer) 导入 CSV 文件。
2. 使用 [SST 提取工具](../../3.build-develop-and-administration/3.deploy-and-administrations/server-administration/storage-service-administration/data-import/download-and-ingest-sst-file.md) 导入 SST 文件。
3. 使用 [Spark Writer](https://docs.nebula-graph.io/manual-CN/3.build-develop-and-administration/3.deploy-and-administrations/server-administration/storage-service-administration/data-import/spark-writer/) 从其他数据平台，如 HDFS，HIVE 等，导入数据。
