...
我们推荐使用 [docker compose](https://github.com/vesoft-inc/nebula-docker-compose) 来安装 **Nebula Graph**， 具体步骤可以参考我们录制的视频。

[![通过 Docker 和 Docker Compose 来安装 Nebula Graph](https://user-images.githubusercontent.com/57335825/80072558-fe76f500-8578-11ea-8fd2-214edec85e6e.png)](https://www.bilibili.com/video/BV1BJ411y7Kt?from=search&seid=2803739759207567290)
...
1. 使用 [Spark Writer](https://docs.nebula-graph.io/manual-CN/3.build-develop-and-administration/3.deploy-and-administrations/server-administration/storage-service-administration/data-import/spark-writer/) 从其他数据平台，如 HDFS，HIVE 等，导入数据。
