...
我们推荐使用 [docker compose](https://github.com/vesoft-inc/nebula-docker-compose) 来安装 **Nebula Graph**， 具体步骤可以参考下面的视频：

<iframe width="560" length="315" src="//player.bilibili.com/player.html?aid=78745928&bvid=BV1BJ411y7Kt&cid=134739315&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
