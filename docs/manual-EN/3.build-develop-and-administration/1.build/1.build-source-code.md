...
# If you want to start the services, cop the configuration files under the etc/ directory
# For production
$ cp etc/nebula-storage.conf.production etc/nebula-storage.conf
$ cp etc/nebula-metad.conf.production etc/nebula-metad.conf
$ cp etc/nebula-metad.conf.production etc/nebula-metad.conf
# For trial
$ cp etc/nebula-storage.conf.default etc/nebula-storage.conf
