...
Use the `make uninstall` command in the `make` directory to uninstall **Nebula Graph**. Please note that the configuration file will not be deleted after uninstalling.
