...
This document introduces the `graphd` configuration file. The default directory is `/usr/local/nebula/etc/`. If you customized your **Nebula Graph** installation directory, the directory of your configuration file is `$pwd/nebula/etc/`.
