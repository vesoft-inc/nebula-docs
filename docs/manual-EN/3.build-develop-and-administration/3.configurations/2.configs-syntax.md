...
wal_ttl                           | MUTABLE | Life time of write-ahead-log in disks. Default value is `14400` secondes. The minimum value is `3600` seconds. When the setting is less than the minimum value, the setting is invalid.
