...
The `SUBMIT JOB COMPACT` command triggers the long time `RocksDB compact` operation. There are a lot of IO operations during the running of this command. When the command is executed (the job status is stopped, see the example below), the read performance can be improved.
...
For more information about the `COMPACT` and `JOB` statement, refer to [here](../../3.build-develop-and-administration/5.storage-service-administration/job-manager.md).
...
Before you start using Nebula Graph, make sure that you read the following documents. They include most of your questions about Nebula Graph. If you still have questions after reading these documents, please head over to our [official forum](https://discuss.nebula-graph.io) to ask.

- [Nebula Graph design and architecture](../3.design-and-architecture/1.design-and-architecture.md)
- [Nebula Graph system requirement](../../3.build-develop-and-administration/3.configurations/0.system-requirement.md)
- [Vertex ID and partitions](../../5.appendix/vid-partition.md)
- [FAQ](2.FAQ.md)
- [Nebula Graph Compact](../../3.build-develop-and-administration/5.storage-service-administration/compact.md)
- [Nebula Graph video tutorial](https://www.youtube.com/channel/UC73V8q795eSEMxDX4Pvdwmw/playlists)
