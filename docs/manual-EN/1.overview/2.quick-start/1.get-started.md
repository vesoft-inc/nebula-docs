...
If you have millions of records to insert, it is recommended to use the [csv importer](../../3.build-develop-and-administration/5.storage-service-administration/data-import/import-csv-file.md).

<!-- (or [sst ingest tool](../../3.build-develop-and-administration/5.storage-service-administration/data-import/download-and-ingest-sst-file.md)) -->
