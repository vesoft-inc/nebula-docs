...
* `vid` is the vertex ID. The current sorting basis is "binary coding order", i.e. 0, 1, 2, ... 9223372036854775807, -9223372036854775807, -9223372036854775806, ..., -1. `vid` supports specifying ID manually, or call hash() function to generate.
