...
`CREATE INDEX` enables you to add indexes to existing tag/edge-type. **Creating index will affect the write performance**. We suggest you import data first and then rebuild the index in batch.
