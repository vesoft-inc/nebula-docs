...
For more information about the `COMPACT` and `JOB` statements, refer to [Job manager](../../3.build-develop-and-administration/5.storage-service-administration/job-manager.md).
...
- You can download the `basketballplayer.ngql` file [here](https://oss-cdn.nebula-graph.com.cn/doc/1.0_basketballplayer.ngql).
