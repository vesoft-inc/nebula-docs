...
This is the **Nebula Graph** User Manual. It documents **Nebula Graph** 1.2.0. For information about which versions have been released, see [Release Notes](https://github.com/vesoft-inc/nebula/releases).
