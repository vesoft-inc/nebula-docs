...
|nebula-exchange_spark_2.4-3.4.0.jar       |  3.x.x         |2.4.x |	|nebula-exchange_spark_2.4-3.x.x.jar       |  3.x.x         |2.4.x |
|nebula-exchange_spark_2.2-3.4.0.jar       |  3.x.x         |2.2.x |	|nebula-exchange_spark_2.2-3.x.x.jar       |  3.x.x         |2.2.x |
