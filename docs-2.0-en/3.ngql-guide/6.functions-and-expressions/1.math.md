...
- `precision`: Decimal digits. If `precision` is less than 0, round at the left of the decimal point.

- `mode`: A string specifying the rounding mode. The following valid values are supported:
