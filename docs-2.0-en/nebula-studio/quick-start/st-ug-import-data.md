...
1. Click **New Import** at the top left corner of the page to complete the following settings:
  ...
  !!! caution
        ...
        Users can also click **Import Template** to download the sample configuration file `example.yaml`, configure it and then upload the configuration file. Configure in the same way as [NebulaGraph Importer](../../import-export/nebula-importer/use-importer.md).
