...
!!! warning
    ...
    When you restore data with snapshots, make sure that the graph spaces backed up in the snapshot have not been deleted. Otherwise, the data of the graph spaces cannot be restored.
