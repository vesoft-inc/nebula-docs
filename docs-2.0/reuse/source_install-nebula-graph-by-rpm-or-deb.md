...
* Download the released version.
    ...
    ```bash
    //Centos 7
    https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.el7.x86_64.rpm

    //Centos 8
    https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.el8.x86_64.rpm

    //Ubuntu 1604
    https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.ubuntu1604.amd64.deb

    //Ubuntu 1804
    https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.ubuntu1804.amd64.deb

    //Ubuntu 2004
    https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.ubuntu2004.amd64.deb
    ```

    For example, download the release package `{{ nebula.release }}` for `Centos 7.5`:

    ```bash
    wget https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.el7.x86_64.rpm
    wget https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.el7.x86_64.rpm.sha256sum.txt
    ```

    Download the release package `{{ nebula.release }}` for `Ubuntu 1804`:

    ```bash
    wget https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.ubuntu1804.amd64.deb
    wget https://github.com/vesoft-inc/nebula/releases/download/v3.5.0/nebula-graph-3.5.0.ubuntu1804.amd64.deb.sha256sum.txt
    ```
