...
* Download the released version.
    ...
    NebulaGraph 3.4.2 has no server installation packages on [GitHub Releases](https://github.com/vesoft-inc/nebula/releases). The previous OSS download links are no longer available. To install a published version, choose a version with packages on that page.
