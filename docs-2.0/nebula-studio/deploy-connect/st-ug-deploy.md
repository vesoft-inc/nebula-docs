...
1. Download the configuration files for the deployment.
   ...
   | ----- | ----- |
   | [nebula-graph-studio-v{{studio.release}}.tar.gz](https://oss-cdn.nebula-graph.com.cn/nebula-graph-studio/nebula-graph-studio-v{{studio.release}}.tar.gz)| v{{nebula.release}} |
