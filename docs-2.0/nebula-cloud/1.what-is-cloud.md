...
Nebula Graph Cloud (Cloud for short) is a product that supports the [Azure](https://azure.microsoft.com/en-us/) platform to build a Nebula Graph database on the cloud and supports one-click deployment of Nebula Graph. You can create a graph database within minutes, and quickly expand computing and storage.
