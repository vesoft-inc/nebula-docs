...
!!! note
    ...
    Ensure that you have executed the `ADD HOSTS` command to add the Storage service to the cluster before importing the example data. For more information, see [Manage Storage hosts](../../4.deployment-and-installation/manage-storage-host.md).
