...
!!! caution
    ...
    Indexes will weaken write performance for (90% or even more). Do not use indexes in a production environment at will, unless you know the impact of using indexes on the business.
