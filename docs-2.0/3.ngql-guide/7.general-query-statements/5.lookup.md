...
- If the specified property is not indexed when using the `LOOKUP` statement, Nebula Graph randomly selects one of the available indexes.
  ...
  !!! compatibility "Legacy version compatibility"
        ...
        Before releases 2.5.0, if the specified property is not indexed when using the `LOOKUP` statement, Nebula Graph reports an error and does not use other indexes.
