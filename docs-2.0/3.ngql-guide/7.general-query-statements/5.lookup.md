...
Before using the `LOOKUP` statement, make sure that relative indexes are created. For how to create indexes, see [CREATE INDEX](../14.index-statements/1.create-index.md).
