...
You also use properties without specifying a tag to get vertices directly. For example, to get all the vertices with the property value Tim Duncan.
...
You also use properties without specifying an edge type to get edges directly. For example, to get all the edges with the property value 90.
