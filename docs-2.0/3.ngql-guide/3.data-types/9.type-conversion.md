...
Nebula Graph supports converting expressions explicit to other types. For details, see [Type conversion functions](../6.functions-and-expressions/16.type-conversion.md).
