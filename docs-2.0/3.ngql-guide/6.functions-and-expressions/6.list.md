...
This topic describes the list functions supported by Nebula Graph. Partial list functions have different syntax between native nGQL statements and openCypher-compatible statements.
