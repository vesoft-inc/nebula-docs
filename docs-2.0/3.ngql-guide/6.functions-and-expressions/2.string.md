...
This topic describes the built-in string functions supported by Nebula Graph.
...
- `string_a`、`string_b`: String to compare.
...
lpad() padding a specified string from the leading and returns a substring of specified length starting at the tail.

Syntax: `lpad(<string>,<count>,<letters>)`

- `string`: A specified string.

- `count`: The length of the string after it has been left-padded. If the length is less than that of the `string`, only the length of the `string` characters **from front to back** will be returned.
...
rpad() padding a specified string from the trailing and returns a substring of specified length starting at the header.

Syntax: `rpad(<string>,<count>,<letters>)`

- `string`: A specified string.

- `count`: The length of the string after it has been right-padded. If the length is less than that of the `string`, only the length of the `string` characters **from front to back** will be returned.
...
toString() takes in any non-compound data type and converts it into a string.
...
hash() takes in a specified string and encodes it into a hash value.
