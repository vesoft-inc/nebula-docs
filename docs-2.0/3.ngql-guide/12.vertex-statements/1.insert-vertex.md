...
!!! caution
    ...
    `INSERT VERTEX` and `CREATE` have different syntax.

    - The syntax of `INSERT VERTEX` is closer to the syntax of INSERT in NoSQL (key-value), or `UPSERT` (`UPDATE` or `INSERT`) in SQL.
