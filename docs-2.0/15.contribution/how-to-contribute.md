...
Contact the official NebulaGraph staff via email, WeChat, Slack, etc. to confirm the donation project. The project will be donated to the [NebulaGraphContrib organization](https://github.com/nebula-contrib).
...
The NebulaGraph official staff will give the recipient ID of the NebulaGraphContrib project.

### Step 3: Donate a project

The user transfers the project to the recipient of this donation, and the recipient transfers the project to the NebulaGraphContrib organization. After the donation, the user will continue to lead the development of community projects as a Maintainer.
