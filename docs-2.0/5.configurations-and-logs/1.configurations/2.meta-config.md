...
| Name        | Predefined value           | Description                  |Whether supports runtime dynamic modifications|
| ----------- | ----------------------- | ---------------------------------------------------- |----------------- |
|`license_manager_url`|-| The address of License Manager. Users need to [deploy a license file](../../4.deployment-and-installation/deploy-license.md) before starting the Enterprise Edition.|No|
