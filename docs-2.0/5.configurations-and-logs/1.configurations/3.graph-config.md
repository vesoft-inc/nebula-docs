...
|`enable_record_slow_query`|`true`|Whether to record slow queries. <br/> Only available in the enterprise version of NebulaGraph.|
|`slow_query_limit`|`100`|The maximum number of slow queries that can be recorded. <br/> Only available in the enterprise version of NebulaGraph.|
