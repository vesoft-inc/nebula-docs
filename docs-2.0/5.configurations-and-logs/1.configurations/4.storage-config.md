...
When you have a large dataset (in the RocksDB directory) and your memory is tight, we suggest that you set the `enable_partitioned_index_filter` parameter to `true`. For example, 100 vertices + 100 edges use 300 keys. Each key is 10bit or 3k. Then you can calculate your own data storage.
