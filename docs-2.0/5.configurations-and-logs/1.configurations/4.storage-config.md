...
| `storage_cache_entries_power` | `20`   |  Estimated number of cache entries on this storage node in base 2 logarithm. E.g., in case of the value 20, the estimated number of entries will be 2$^{20}$. A good value of this parameter can be log2(#vertices on this storage node * #tags). The maximum allowed is 31.|
