...
The LM periodically synchronizes the license key information from LC every 1 to 2 hours. You can also manually synchronize the license key using the following command.
