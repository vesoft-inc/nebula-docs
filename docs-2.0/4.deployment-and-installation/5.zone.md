...
1. In the configuration file `nebula-metad.conf` of the Meta service, manually add the `--zone_list` flag and set its value to Zone names to be added, such as `--assigned_zone=zone1, zone2, zone3`.
