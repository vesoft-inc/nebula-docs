...
- After enabling the Zone feature, you must include the `INTO ZONE` keywords when executing the `ADD HOSTS` command; otherwise, adding a Storage node will fail.
