...
1. NebulaGraph 3.4.3 has no server tar.gz packages on [GitHub Releases](https://github.com/vesoft-inc/nebula/releases). The previous OSS download links are no longer available. To install a published version, choose a version with packages on that page.
