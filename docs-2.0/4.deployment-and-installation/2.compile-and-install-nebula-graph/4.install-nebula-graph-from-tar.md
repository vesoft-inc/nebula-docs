...
1. Download the NebulaGraph tar.gz file using the following address.
  ...
  ```bash
  //Centos 7
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.el7.x86_64.tar.gz
  //Checksum
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.el7.x86_64.tar.gz.sha256sum.txt
  
  //Centos 8
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.el8.x86_64.tar.gz
  //Checksum
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.el8.x86_64.tar.gz.sha256sum.txt
  
  //Ubuntu 1604
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.ubuntu1604.amd64.tar.gz
  //Checksum
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.ubuntu1604.amd64.tar.gz.sha256sum.txt
  
  //Ubuntu 1804
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.ubuntu1804.amd64.tar.gz
  //Checksum
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.ubuntu1804.amd64.tar.gz.sha256sum.txt
  
  //Ubuntu 2004
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.ubuntu2004.amd64.tar.gz
  //Checksum
  https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.ubuntu2004.amd64.tar.gz.sha256sum.txt
  ```
  
  For example, to download the NebulaGraph {{nebula.branch}} tar.gz file for `CentOS 7.5`, run the following command:
  
  ```bash
  wget https://github.com/vesoft-inc/nebula/releases/download/v3.2.1/nebula-graph-3.2.1.el7.x86_64.tar.gz
  ```
