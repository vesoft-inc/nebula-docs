...
3. Run the following command to start all the Nebula Graph services.
  ...
  Starting with <version>, Nebula Graph supports ARM64 docker images on ARM. You can run containerized Nebula Graph databases on Docker Desktop for ARM macOS or on an ARM Linux server. 
  -->
