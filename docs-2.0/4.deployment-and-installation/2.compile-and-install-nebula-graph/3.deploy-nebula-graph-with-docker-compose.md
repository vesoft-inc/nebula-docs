...
4. Connect to Nebula Graph.
  ...
  !!! Note
        ...
        Starting from Nebula Graph version 3.1.0, the docker-compose automatically starts a Nebula Console docker container and adds the storage host to the cluster (i.e. `ADD HOSTS` command).
