...
4. Connect to NebulaGraph.
  ...
  !!! Note
        ...
        Starting from NebulaGraph version 3.1.0, nebula-docker-compose automatically starts a Nebula Console docker container and adds the storage host to the cluster (i.e. `ADD HOSTS` command).
   ...
   3. Connect to NebulaGraph with Nebula Console.
...
The command `docker-compose pull` updates both the NebulaGraph services and the Nebula Console.
