...
The correspondence between the Dashboard release and the NebulaGraph release is as follows.

|Dashboard|NebulaGraph|
|:---|:---|
...
|nebula-http-gateway | Provides HTTP ports for cluster services to execute nGQL statements to interact with the NebulaGraph database. |
