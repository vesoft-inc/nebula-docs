...
![Overview](https://docs-cdn.nebula-graph.com.cn/figures/overview.png)
...
- CPU, Memory, Load, Disk, Network
  ...
  ![Machine](https://docs-cdn.nebula-graph.com.cn/figures/machine.png)
...
- Graph, Meta, Storage
  ...
  ![Service](https://docs-cdn.nebula-graph.com.cn/figures/service.png)
