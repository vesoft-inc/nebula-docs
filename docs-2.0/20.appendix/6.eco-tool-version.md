...
![NebulaGraph birdview](https://docs-cdn.nebula-graph.com.cn/figures/nebula-graph-birdview-3.0.0.png)
...
Nebula Analytics is an application that integrates the open-source Plato Graph Computing Framework, with which Nebula Analytics performs graph computations on NebulaGraph database data. For details, see [What is Nebula Analytics](../graph-computing/nebula-analytics.md).
...
Nebula Console is the native CLI client of NebulaGraph. For how to use it, see [Nebula Console](../nebula-console.md).
...
[Nebula Bench](https://github.com/vesoft-inc/nebula-bench/releases/tag/{{bench.tag}}) is used to test the baseline performance data of NebulaGraph. It uses the standard data set of LDBC.
