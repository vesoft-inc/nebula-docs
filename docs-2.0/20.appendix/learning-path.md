...
### 3.2 Upgrade NebulaGraph
  ...
  <!-- | [Upgrade NebulaGraph from v2.0.x to {{nebula.branch}}](../4.deployment-and-installation/3.upgrade-nebula-graph/upgrade-nebula-from-300-to-latest.md) | -->
...
- Data import and export
  ...
  | Data import       | [Nebula Spark Connector](../nebula-spark-connector.md) | -                                                            |
  | Data import       | [Nebula Flink Connector](../nebula-flink-connector.md) | -                                                            |
...
Now you could get NebulaGraph Certifications from [Nebula Academy](https://academic.nebula-graph.io).
