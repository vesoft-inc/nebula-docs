...
Within 3 days before and 7 days after the expiration of the license, you receive an alert about the license expiration. 

| Time | Software usage status       | Alerts and renewals                                           |
| ---------------- | ------------------ | ------------------------------------------------------------ |
| Outside of the effective date  | Cannot log into your account and cannot use the service.     | The license you are using is invalid. Please use it only within the validity period.           |
| Within 3 days before the expiration date      | Can log into your account and continue using the service. | Your license will expire in <3|2|1|0> day(s). The service can not be used after 7 days of the expiration date. Contact our support team via [inqury@vesoft.com](mailto:inqury@vesoft.com) to buy a new license or renewal your license. |
| Within 7 days after the expiration date      | Can log into your account and continue using the service. | Your license has expired for <0|1|2|3|4|5|6|7> day(s). The service can not be used after 7 days of the expiration date. Contact our support team via [inqury@vesoft.com](mailto:inqury@vesoft.com) to buy a new license or renewal your license. |
| After 7 days of the expiration date    | Cannot log into your account and cannot use the service.     | Your license has expired for more than 7 days and the service can not be used. Contact our support team via [inqury@vesoft.com](mailto:inqury@vesoft.com) to buy a new license or renewal your license. |