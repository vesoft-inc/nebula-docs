...
- Before the installation starts, the following ports are not occupied.
  ...
  | 9100   | The port of the node-exporter service, used to collect the source information of machines in the cluster, including the CPU, memory, load, disk, and network.   |
