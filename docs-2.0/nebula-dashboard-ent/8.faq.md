...
Users can use third-party high-availability software (e.g. HAProxy) to implement the high-availability architecture for Dashboard and the high-availability architecture for LM.
