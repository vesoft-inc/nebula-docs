...
Cluster members must be included in Dashboard accounts. For information about how to create an account, see [Authority management](../5.account-management.md).
...
2. On the left-side navigation bar of the page, click **Operation**->**Member Management**.
3. On the **Member Management** page, click the search box at the top left, and in the drop-down list, select the target account that you want to add to be the administrator of the cluster, and then click **Add**.
