...
- **Creator**：The Dashboard account that used to create the cluster. 
...
!!! enterpriseonly
    ...
    - **When the license expires, you cannot perform operations on the current cluster.** Click **Upload License** to upload a new license.
