...
This topic introduces the cluster information of Dashboard from two parts **Overview Info** and **Cluster Diagnosis**. The **Overview Info** section displays the overview information of the Nebula Graph cluster. The **Cluster Diagnosis** section displays the cluster diagnosis information of the Nebula Graph cluster.
...
You can click **Cluster Diagnosis** under the **Cluster Information** menu bar to locate and analyze the problem that occurs in the cluster. For details, see [Cluster Diagnosis](7.cluster-diagnosis.md).
