...
At the top navigation bar of the Dashboard Enterprise Edition page, click **Cluster Management**, and on the left-side navigation bar of the page, click **Information**, you will see the following six parts:
