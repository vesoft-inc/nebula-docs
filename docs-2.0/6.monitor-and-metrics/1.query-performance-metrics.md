...
The name of space-level metrics include the graph space names in the form of `{space=space_name}`, for example,  `query_latency_us{space=basketballplayer}.avg.3600`.
