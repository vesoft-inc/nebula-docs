...
Storage Service is run by nebula-storaged process. Users can deploy nebula-storaged processes on different occasions. For example, users can deploy 1 nebula-storaged process in the test environment while deploying 3 nebula-storaged processes in the production environment.
