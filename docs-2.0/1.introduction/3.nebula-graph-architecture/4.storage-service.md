...
- Storage interface
   ...
   The top layer is storage interface. It defines a set of APIs that are related to the graph. These API requirements will be translated into a set of KV operations targeting the corresponding [Partition](#data_partitioning). For example:
