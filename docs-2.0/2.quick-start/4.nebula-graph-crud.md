...
You can add indexes to tags or edge types with the [CREATE INDEX](../3.ngql-guide/14.index-statements/1.create-native-index.md) statement.
...
* Rebuild indexes for pre-existing data. Otherwise, the pre-existing data can't be indexed. For more information, see [Rebuild indexes](../3.ngql-guide/14.index-statements/4.rebuild-native-index.md).
