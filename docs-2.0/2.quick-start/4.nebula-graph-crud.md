...
## Manage the Storage services in the Nebula Graph cluster

First, we add the Storage services to the Nebula Graph cluster. For more information, see [Manage logical rack](../4.deployment-and-installation/5.zone.md)。
