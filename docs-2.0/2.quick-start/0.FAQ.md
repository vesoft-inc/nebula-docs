...
!!! warning "Major version compactibility"

    Neubla Graph {{ nebula.release }} is not compactible with Nebula Graph 1.x nor 2.0-RC in both data formats and rpc-protocals, and vise versa. 
...
!!! note "Micro version compactibility"

    Neubla Graph {{ nebula.release }} is compactible with Nebula Graph {{ nebula.base20 }} in both data formats and rpc-protocals.
