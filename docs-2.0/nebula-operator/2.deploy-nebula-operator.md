...
!!! Compatibility
    ...
    Since the log and data disks of the v0.9.0 Nebula Operator are stored separately, operations on the 2.5.x Nebula Graph cluster with the upgraded Operator can cause compatibility issues. You can backup data of the 2.5.x Nebula Graph cluster and then create a cluster of the 2.6.x version with the upgraded Operator.
