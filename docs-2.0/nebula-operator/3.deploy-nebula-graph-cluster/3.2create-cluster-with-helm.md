...
6. Apply the variables to the Helm chart to create a NebulaGraph cluster.
  ...
  helm install "${NEBULA_CLUSTER_NAME}" nebula-operator/nebula-cluster \
      ...
      --set nebula.version=v{{nebula.release}} \  # The v{{nebula.release}} is only available in the Enterprise Edition.
      ...
      --set nebula.metad.license.licenseKey=nebula.license
  ```
