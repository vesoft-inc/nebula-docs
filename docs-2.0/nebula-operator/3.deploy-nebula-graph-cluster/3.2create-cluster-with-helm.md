...
| `nebula.version`            | `v2.5.1`                                                     | The version of NebulaGraph.                                        |
...
| `nebula.podLabels`          | `{}`                                                         | Labels for pods in a NebulaGraph cluster.                                  |
| `nebula.podAnnotations`     | `{}`                                                         | Pod annotations in a NebulaGraph cluster.                                     |
