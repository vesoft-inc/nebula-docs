...
## Does NebulaGraph Operator support the rolling upgrade feature for NebulaGraph clusters?

NebulaGraph Operator currently supports cluster upgrading from version 2.5.x to version 2.6.x.
