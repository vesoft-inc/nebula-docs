...
You can define whether or not to balance data automatically with the parameter `enableAutoBalance` in the configuration file of the CR instance of the cluster you created.
