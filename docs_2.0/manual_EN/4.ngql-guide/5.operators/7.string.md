...
(NOT) STARTS WITH | Whether a value starts with a certain value (or not)
(NOT) ENDS WITH | Whether a value ends with a certain value (or not)

> **NOTE:** All the string operators perform case-sensitive matching.
